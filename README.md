...
코디세이 올인원 과정에서 수행한 여러 미션을 모아둔 저장소입니다. 이 README는 "개발 워크스테이션" 미션 문서이며, 함께 들어있는 다른 프로젝트는 아래에서 확인할 수 있습니다.
...
| [02. Docker 기본](md/02-doccker-basics.md) | 설치/데몬 점검, hello-world, ubuntu 실습, run vs exec 관찰, 운영 명령 |
